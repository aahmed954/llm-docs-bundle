...
`,ot={CausalLM:Xi,TextToImage:Yi,TextClassifier:Gi,ImageClassifier:Zi},en=(e,a)=>`
import keras_hub
...
model = VoiceCraft.from_pretrained("${e.id}")`],Gn=()=>[`import ChatTTS
import torchaudio
...
model.predict(source=source, save=True)`]},Zn=e=>[`# Option 1: use with transformers
...
`)}function _l(e,a){return e.endsWith(a)?e.slice(0,-a.length):e}export{Il as E,Sl as H,de as I};
